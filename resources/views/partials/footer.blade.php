<div class="container-fluid bg-dark text-light footer wow fadeIn h-50" data-wow-delay="0.1s">
    <div class="container pb-5 mt-5">
        <div class="row g-5">
            ...
            <div class="col-md-6 col-lg-3">
                ...
                <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Hotel La Chambotte, Imouzzer Kandar</p>
            ...
            <div class="col-lg-5 col-md-12">
                <div class="row gy-5 g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <a class="btn btn-link" href="">Alimentation & Restauration</a>
                        <a class="btn btn-link" href="">Spa et la salle du sport</a>
